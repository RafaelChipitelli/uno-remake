...
- Files: PascalCase for classes/Phaser scenes (`GameScene.ts`, `CardStage.ts`), camelCase for modules/utilities (`titleScreen.ts`, `roomState.ts`). Directories lowercase (`scenes`, `core`).
